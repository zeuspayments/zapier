    ...
    operation: {
        ...
        inputFields: [
            ...
            Util.inputFields.currency_code,
            {
                ...
                label: 'Order ID',
                type: 'string',
                helpText: 'The Order ID you want to see in ZEUSPay',
                required: false,
                list: false,
            ...
            },
            {
                ...
                label: 'Redirect URL',
                type: 'string',
                helpText: 'When the customer has paid the invoice, the URL where the customer will be sent to when clicking on the "Return to store" button. You can use the placeholders `{InvoiceId}` and `{OrderId}` in the URL. ZEUSPay will replace those with this invoice `id` or the `metadata.orderId` values respectively.',
                required: false,
                list: false,
                altersDynamicFields: false,
            },
